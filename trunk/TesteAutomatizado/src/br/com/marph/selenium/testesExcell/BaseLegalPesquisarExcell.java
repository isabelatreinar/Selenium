...
public class BaseLegalPesquisarExcell {
	...
	public void teste() {
		...
		try {
			...
			tipo2.click();
			WebElement procuraTipoBase1 = driver
					.findElement(By.xpath("//li[@data-option-array-index='" + tipoEditar + "']"));
			...
			WebElement anoVigenciaSeleciona1 = driver
					.findElement(By.xpath("//*[@id='dataVigencia_chosen']/div/ul/li[" + anoEditar + "]"));
