...
public class QtdeRegistroResolucao {
	/**
	...
	@Test
	public void qtdeRegistrosResolucao() throws TesteAutomatizadoException, InterruptedException {
		 ...
		 * A instrução Thread.sleep(1000) é necessária pois a rapidez da execução dos testes estava gerando uma
	...
	public void selecionarQuantidade(WebDriver driver, String valor) {
		Select selecionarValor = new Select(
				driver.findElement(By.xpath("//div[@id='resolucaoDataTable_length']/label/select")));
	...
	public int contaRegistros(WebDriver driver) {
		 ...
		 * O comando cssSelector("tbody tr") desconsidera a linha de cabeçalho da listagem.
		 **/
