...
public class LimparPesquisaHistoricoTipoBaseLegal {
	...
	@Test
	public void limparPesquisaHistoricoTipoBaseLegal() {
		...
		// Fazer pesquisa de tipo de base legal e completar o teste
		// já tem pronto, só alterar o id do filtro campo alterado
		//fazer validação do limpar pesquisa de tipo de base legal (tela de listagem)
